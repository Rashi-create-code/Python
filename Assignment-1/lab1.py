#Rashi Mangal
#Date-11 Nov 2025
#Project Title- Calorie Tracker CLI
...
if total>limit:
    print("⚠️ Warning: Your calorie intake exceeds the recommended daily intake!")
else:
...
if save == "yes":
    ...
    print("📁 Session has been saved successfully as 'calorie_log.txt'!")
else:
