...
1️⃣ Daily Consumption Line Chart
2️⃣ Weekly Average Bar Chart
3️⃣ Peak Load Scatter Plot
...
1️⃣ Place your building CSV files inside /data
2️⃣ Run the script:

python main.py

3️⃣ Check results in the /output folder ✔
